...
// ------------------------------------------------------------
        ...
        private void SetupButtons()
        {
            ...
            // Grid
            ChartButtons[(int) Forex_Strategy_Trader.ChartButtons.Grid].Image = Resources.chart_grid;
            ChartButtons[(int) Forex_Strategy_Trader.ChartButtons.Grid].ToolTipText = Language.T("Grid") + "   G";
            ChartButtons[(int) Forex_Strategy_Trader.ChartButtons.Grid].Checked = Configs.ChartGrid;

            // Cross
            ChartButtons[(int) Forex_Strategy_Trader.ChartButtons.Cross].Image = Resources.chart_cross;
            ChartButtons[(int) Forex_Strategy_Trader.ChartButtons.Cross].ToolTipText = Language.T("Cross") + "   C";
            ChartButtons[(int) Forex_Strategy_Trader.ChartButtons.Cross].Checked = Configs.ChartCross;

            // Volume
            ChartButtons[(int) Forex_Strategy_Trader.ChartButtons.Volume].Image = Resources.chart_volume;
            ChartButtons[(int) Forex_Strategy_Trader.ChartButtons.Volume].ToolTipText = Language.T("Volume") + "   V";
            ChartButtons[(int) Forex_Strategy_Trader.ChartButtons.Volume].Checked = Configs.ChartVolume;

            // Orders
            ChartButtons[(int) Forex_Strategy_Trader.ChartButtons.Orders].Image = Resources.chart_entry_points;
            ChartButtons[(int) Forex_Strategy_Trader.ChartButtons.Orders].ToolTipText = Language.T("Orders") + "   O";
            ChartButtons[(int) Forex_Strategy_Trader.ChartButtons.Orders].Checked = Configs.ChartOrders;

            // Position lots
            ChartButtons[(int) Forex_Strategy_Trader.ChartButtons.PositionLots].Image = Resources.chart_lots;
            ChartButtons[(int) Forex_Strategy_Trader.ChartButtons.PositionLots].ToolTipText =
                Language.T("Position lots") + "   L";
            ChartButtons[(int) Forex_Strategy_Trader.ChartButtons.PositionLots].Checked = Configs.ChartLots;

            // Position price
            ChartButtons[(int) Forex_Strategy_Trader.ChartButtons.PositionPrice].Image = Resources.chart_pos_price;
            ChartButtons[(int) Forex_Strategy_Trader.ChartButtons.PositionPrice].ToolTipText =
                Language.T("Position price") + "   P";
            ChartButtons[(int) Forex_Strategy_Trader.ChartButtons.PositionPrice].Checked = Configs.ChartPositionPrice;

            // Zoom in
            ChartButtons[(int) Forex_Strategy_Trader.ChartButtons.ZoomIn].Image = Resources.chart_zoom_in;
            ChartButtons[(int) Forex_Strategy_Trader.ChartButtons.ZoomIn].ToolTipText = Language.T("Zoom in") + "   +";

            // Zoom out
            ChartButtons[(int) Forex_Strategy_Trader.ChartButtons.ZoomOut].Image = Resources.chart_zoom_out;
            ChartButtons[(int) Forex_Strategy_Trader.ChartButtons.ZoomOut].ToolTipText = Language.T("Zoom out") + "   -";

            // Refresh
            ChartButtons[(int) Forex_Strategy_Trader.ChartButtons.Refresh].Image = Resources.chart_refresh;
            ChartButtons[(int) Forex_Strategy_Trader.ChartButtons.Refresh].ToolTipText = Language.T("Refresh chart") +
                                                                                         "   F5";

            // True Charts
            ChartButtons[(int) Forex_Strategy_Trader.ChartButtons.TrueCharts].Image = Resources.chart_true_charts;
            ChartButtons[(int) Forex_Strategy_Trader.ChartButtons.TrueCharts].Checked = Configs.ChartTrueCharts;
            ChartButtons[(int) Forex_Strategy_Trader.ChartButtons.TrueCharts].ToolTipText =
                Language.T("True indicator charts") + "   T";

            // Shift
            ChartButtons[(int) Forex_Strategy_Trader.ChartButtons.Shift].Image = Resources.chart_shift;
            ChartButtons[(int) Forex_Strategy_Trader.ChartButtons.Shift].ToolTipText = Language.T("Chart shift") +
                                                                                       "   S";
            ChartButtons[(int) Forex_Strategy_Trader.ChartButtons.Shift].Checked = Configs.ChartShift;

            // Auto Scroll
            ChartButtons[(int) Forex_Strategy_Trader.ChartButtons.AutoScroll].Image = Resources.chart_auto_scroll;
            ChartButtons[(int) Forex_Strategy_Trader.ChartButtons.AutoScroll].ToolTipText = Language.T("Auto scroll") +
                                                                                            "   R";
            ChartButtons[(int) Forex_Strategy_Trader.ChartButtons.AutoScroll].Checked = Configs.ChartAutoScroll;

            // Show dynamic info
            ChartButtons[(int) Forex_Strategy_Trader.ChartButtons.DynamicInfo].Image = Resources.chart_dyninfo;
            ChartButtons[(int) Forex_Strategy_Trader.ChartButtons.DynamicInfo].Checked = Configs.ChartInfoPanel;
            ChartButtons[(int) Forex_Strategy_Trader.ChartButtons.DynamicInfo].ToolTipText =
                Language.T("Show / hide info panel") + "   I";

            // Move Dynamic Info Down
            ChartButtons[(int) Forex_Strategy_Trader.ChartButtons.DInfoDwn].Image = Resources.chart_dinfo_down;
            ChartButtons[(int) Forex_Strategy_Trader.ChartButtons.DInfoDwn].ToolTipText = Language.T("Move info down") +
                                                                                          "   Z";
            ChartButtons[(int) Forex_Strategy_Trader.ChartButtons.DInfoDwn].Visible = _isInfoPanelShown;

            // Move Dynamic Info Up
            ChartButtons[(int) Forex_Strategy_Trader.ChartButtons.DInfoUp].Image = Resources.chart_dinfo_up;
            ChartButtons[(int) Forex_Strategy_Trader.ChartButtons.DInfoUp].ToolTipText = Language.T("Move info up") +
                                                                                         "   A";
            ChartButtons[(int) Forex_Strategy_Trader.ChartButtons.DInfoUp].Visible = _isInfoPanelShown;
        }
        ...
        private void ButtonChartClick(object sender, EventArgs e)
        {
            ...
            switch (buton)
            {
                case Forex_Strategy_Trader.ChartButtons.Grid:
                    ShortcutKeyUp(new KeyEventArgs(Keys.G));
                    break;
                case Forex_Strategy_Trader.ChartButtons.Cross:
                    ShortcutKeyUp(new KeyEventArgs(Keys.C));
                    break;
                case Forex_Strategy_Trader.ChartButtons.Volume:
                    ShortcutKeyUp(new KeyEventArgs(Keys.V));
                    break;
                case Forex_Strategy_Trader.ChartButtons.Orders:
                    ShortcutKeyUp(new KeyEventArgs(Keys.O));
                    break;
                case Forex_Strategy_Trader.ChartButtons.PositionLots:
                    ShortcutKeyUp(new KeyEventArgs(Keys.L));
                    break;
                case Forex_Strategy_Trader.ChartButtons.PositionPrice:
                    ShortcutKeyUp(new KeyEventArgs(Keys.P));
                    break;
                case Forex_Strategy_Trader.ChartButtons.ZoomIn:
                    ShortcutKeyUp(new KeyEventArgs(Keys.Add));
                    break;
                case Forex_Strategy_Trader.ChartButtons.ZoomOut:
                    ShortcutKeyUp(new KeyEventArgs(Keys.Subtract));
                    break;
                case Forex_Strategy_Trader.ChartButtons.Refresh:
                    ShortcutKeyUp(new KeyEventArgs(Keys.F5));
                    break;
                case Forex_Strategy_Trader.ChartButtons.TrueCharts:
                    ShortcutKeyUp(new KeyEventArgs(Keys.T));
                    break;
                case Forex_Strategy_Trader.ChartButtons.Shift:
                    ShortcutKeyUp(new KeyEventArgs(Keys.S));
                    break;
                case Forex_Strategy_Trader.ChartButtons.AutoScroll:
                    ShortcutKeyUp(new KeyEventArgs(Keys.R));
                    break;
                case Forex_Strategy_Trader.ChartButtons.DInfoDwn:
                    ShortcutKeyUp(new KeyEventArgs(Keys.Z));
                    break;
                case Forex_Strategy_Trader.ChartButtons.DInfoUp:
                    ShortcutKeyUp(new KeyEventArgs(Keys.A));
                    break;
                case Forex_Strategy_Trader.ChartButtons.DynamicInfo:
        ...
        private void ShortcutKeyUp(KeyEventArgs e)
        {
            ...
            else if (e.KeyCode == Keys.G)
            {
                ...
                ChartButtons[(int) Forex_Strategy_Trader.ChartButtons.Grid].Checked = _isGridShown;
                InvalidateAllPanels();
            }
                // Cross
            else if (e.KeyCode == Keys.C)
            {
                ...
                ChartButtons[(int) Forex_Strategy_Trader.ChartButtons.Cross].Checked = _isCrossShown;
                InvalidateAllPanels();
                if (_isCrossShown)
                {
            ...
            else if (e.KeyCode == Keys.V)
            {
                ...
                ChartButtons[(int) Forex_Strategy_Trader.ChartButtons.Volume].Checked = _isVolumeShown;
                SetPriceChartMinMaxValues();
                PnlPrice.Invalidate();
            }
                // Lots
            else if (e.KeyCode == Keys.L)
            {
                ...
                ChartButtons[(int) Forex_Strategy_Trader.ChartButtons.PositionLots].Checked = _isPositionLotsShown;
                SetPriceChartMinMaxValues();
                PnlPrice.Invalidate();
            }
                // Orders
            else if (e.KeyCode == Keys.O)
            {
                ...
                ChartButtons[(int) Forex_Strategy_Trader.ChartButtons.Orders].Checked = _isOrdersShown;
                PnlPrice.Invalidate();
            }
                // Position price
            else if (e.KeyCode == Keys.P)
            {
                ...
                ChartButtons[(int) Forex_Strategy_Trader.ChartButtons.PositionPrice].Checked = _isPositionPriceShown;
                PnlPrice.Invalidate();
            }
                // True Charts
            else if (e.KeyCode == Keys.T)
            {
                ...
                ChartButtons[(int) Forex_Strategy_Trader.ChartButtons.TrueCharts].Checked = _isTrueChartsShown;
                InvalidateAllPanels();
            }
                // Chart shift
            else if (e.KeyCode == Keys.S)
            {
                ...
                ChartButtons[(int) Forex_Strategy_Trader.ChartButtons.Shift].Checked = _isChartShift;
                SetFirstLastBar();
            }
                // Chart Auto Scroll
            else if (e.KeyCode == Keys.R)
            {
                ...
                ChartButtons[(int) Forex_Strategy_Trader.ChartButtons.AutoScroll].Checked = _isChartAutoScroll;
                SetFirstLastBar();
            }
